  ...
  return (
    <Box>
      <RivarPageHeader
        ...
        subtitle={t('weights.configureOptimizationFactors')}
        actions={<Button variant="contained" size="small" startIcon={<AddIcon sx={{ fontSize: 15 }} />} onClick={handleOpenCreate}>{t('weights.addWeight')}</Button>}
      />
