...
export const ProcurementPlanPage: React.FC = () => {
  ...
  return (
    <Box>
      <RivarPageHeader
        title={t('procurementPlan.titleWithDelivery')}
        actions={<Button variant="outlined" size="small" startIcon={<ExportIcon sx={{ fontSize: 15 }} />} onClick={handleExport}>{t('procurementPlan.exportToExcel')}</Button>}
      />
