...
export const CurrencyManagementPage: React.FC = () => {
  ...
  return (
    <Box>
      <RivarPageHeader
        title={t('finance.currencyManagement')}
        actions={<Button variant="contained" size="small" startIcon={<AddIcon sx={{ fontSize: 15 }} />} onClick={() => setCurrencyDialogOpen(true)}>{t('finance.addCurrency')}</Button>}
      />
