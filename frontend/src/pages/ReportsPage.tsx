  ...
  return (
    <Box>
      <RivarPageHeader
        ...
        actions={<Button variant="outlined" size="small" startIcon={<ExportIcon sx={{ fontSize: 15 }} />} onClick={handleExport} disabled={loading || !reportsData}>{t('reports.exportToExcel')}</Button>}
      />
