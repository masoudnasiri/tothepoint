...
- Sprint 5C-R1 RBAC UX + Master Data Permission Pilot (`PASS WITH MINOR ISSUES`, `60_*`): branch `restart/sprint5c-r1-rbac-ux-masterdata-permission-pilot` @ `95c6a87` parent; unified Users & Access Control nav, user RBAC role assignment, permission matrix UX, Items Master/Suppliers pilot enforcement (backend + frontend)
