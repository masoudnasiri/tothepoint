...
- Sprint 5C-R2 Role UI / User Role / Provenance Fix (`PASS WITH MINOR ISSUES`, `62_*`): branch `restart/sprint5c-r2-role-ui-user-role-provenance-fix`; Role Management two-panel layout; single Roles selector; GitHub provenance documented (`main` behind `restart/sprint5c*`)
