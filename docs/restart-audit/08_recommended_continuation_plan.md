...
- Sprint 5B Backend RBAC Foundation (`PASS`, `57_*`): branch `restart/sprint5b-backend-rbac-foundation`; RBAC tables, registry, APIs, `/auth/me` permissions, lockout protection; enforcement flag off
