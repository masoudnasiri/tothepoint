#!/usr/bin/env bash
# Sprint 5E-R1: rebuild /opt/rivar-demo frontend (assignment UX relocation).
set -euo pipefail
...
DEPLOY_BRANCH="${2:-restart/sprint5e-r1-procurement-assignment-ux-relocation}"

echo "=== Rivar demo update deploy (5E-R1) ==="
