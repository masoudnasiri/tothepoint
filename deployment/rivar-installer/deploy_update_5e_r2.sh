#!/usr/bin/env bash
# Sprint 5E-R2: rebuild /opt/rivar-demo frontend (assignment workbench UX).
set -euo pipefail
...
DEPLOY_BRANCH="${2:-restart/sprint5e-r2-procurement-assignment-workbench-view-modes}"

echo "=== Rivar demo update deploy (5E-R2) ==="
