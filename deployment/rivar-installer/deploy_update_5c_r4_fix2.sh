#!/usr/bin/env bash
# Sprint 5C-R4-Fix-2: rebuild /opt/rivar-demo after syncing source (preserve .env + DB volume).
set -euo pipefail
...
DEPLOY_BRANCH="${2:-restart/sprint5c-r4-fix2-rbac-labels-masterdata-leakage}"

echo "=== Rivar demo update deploy (5C-R4-Fix-2) ==="
