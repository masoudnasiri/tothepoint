#!/usr/bin/env bash
# Sprint 5E-R3: rebuild /opt/rivar-demo frontend (bulk remove procurement assignments UX).
set -euo pipefail
...
DEPLOY_BRANCH="${2:-restart/sprint5e-r3-bulk-remove-procurement-assignments}"

echo "=== Rivar demo update deploy (5E-R3) ==="
