#!/usr/bin/env bash
# Sprint 5F: procurement assignment scope enforcement and workflow filtering.
set -euo pipefail
...
DEPLOY_BRANCH="${2:-restart/sprint5f-procurement-assignment-scope-enforcement}"
DEPLOYED_AT="$(date -u +%Y-%m-%dT%H:%M:%SZ)"

echo "=== Rivar demo update deploy (5F) ==="
